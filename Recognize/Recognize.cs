...
namespace GoogleCloudSamples
{
    ...
    public class Recognize
    {
        ...
        public static int implementCommand(ArrayList word_list)
        {
            int counter = 1;
            int cmp;
            String t;
            ...
            if (cmp == 0)
            {
                ...
                {
                    Console.WriteLine(counter + ". Command is : " + command);
                    counter++;
        ...
        public static ArrayList getWordList()
        {
            ...
            Task<object> task = StreamingMicRecognizeAsync(10);
            task.Wait();
            Object result = task.Result;
            temp = (ArrayList)result;
            return temp;
        }

        public static int getCommand(int cmp)
        {
            ...
            if (cmp == 0)
            {
                ...
                return implementCommand(word_list);
            }
            else
            {
                Console.WriteLine("See you..");
        ...
        public static int Main(string[] args)
        {
            ...
            Console.WriteLine("Press y for giving a command.\n");
            String t = Console.ReadLine();
            int cmp = String.Compare(t, "y", ignoreCase: true);
            getCommand(cmp);
